...
public class ClipPictureActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Bitmap srcBitmap = FaceImageUtil.getScaledBitmap(mImageUrl, FaceUIUtil.getScreenWidth(), FaceUIUtil.getScreenHeight());
    ...
    public void saveBitmap(Bitmap bitmap, String fileName) {
        File file = new File(FaceFileUtil.getPicClipDir(), System.currentTimeMillis() + "_" + fileName);

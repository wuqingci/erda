...
public class PullToRefreshRecyclerView extends PullToRefreshBase<RecyclerView> {
    ...
    protected boolean isReadyForPullEnd() {
        ...
        if (childCount > 0 && lastVisiblePosition >= mRefreshableView.getAdapter().getItemCount()-1) {
            return mRefreshableView.getChildAt(childCount - 1).getBottom() <= mRefreshableView.getBottom();
        }
        return false;
    }

...
import com.jingge.pulltorefreshlibrary.internal.FlipLoadingLayout;
import com.jingge.pulltorefreshlibrary.internal.LoadingLayout;
import com.jingge.pulltorefreshlibrary.internal.RotateLoadingLayout;
import com.jingge.pulltorefreshlibrary.internal.Utils;
import com.jingge.pulltorefreshlibrary.internal.ViewCompat;
	...
	protected final void setHeaderScroll(int value) {
		...
		if (mLayoutVisibilityChangesEnabled) {
			if (value < 0) {
              ...
              onHeaderVisibilityChanged(true);
			} else if (value > 0) {
